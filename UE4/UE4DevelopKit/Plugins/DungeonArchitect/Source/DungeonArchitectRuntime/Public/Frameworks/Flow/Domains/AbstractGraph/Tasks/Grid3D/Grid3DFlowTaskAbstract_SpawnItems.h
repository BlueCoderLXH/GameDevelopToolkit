...
#include "Grid3DFlowTaskAbstract_SpawnItems.generated.h"

UCLASS(Meta = (AbstractTask, Title = "Spawn Items", Tooltip = "Spawn items in the layout nodes", MenuPriority = 1300))
class DUNGEONARCHITECTRUNTIME_API UGrid3DFlowTaskAbstract_SpawnItems : public UFlowTaskAbstract_SpawnItems {
    GENERATED_BODY()
public:
