...
#include "Grid3DFlowTaskAbstract_CreateKeyLock.generated.h"

UCLASS(Meta = (AbstractTask, Title = "Create Key/Lock", Tooltip = "Creates a Key/Lock along a path", MenuPriority = 1400))
class DUNGEONARCHITECTRUNTIME_API UGrid3DFlowTaskAbstract_CreateKeyLock : public UFlowTaskAbstract_CreateKeyLock {
    GENERATED_BODY()
public:
