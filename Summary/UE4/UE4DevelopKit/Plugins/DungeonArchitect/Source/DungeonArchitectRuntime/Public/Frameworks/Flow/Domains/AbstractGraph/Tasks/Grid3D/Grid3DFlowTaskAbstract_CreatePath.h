...
#include "Grid3DFlowTaskAbstract_CreatePath.generated.h"

UCLASS(Meta = (AbstractTask, Title = "Create Path", Tooltip = "Create a path on an existing network", MenuPriority = 1200))
class DUNGEONARCHITECTRUNTIME_API UGrid3DFlowTaskAbstract_CreatePath : public UFlowTaskAbstract_CreatePath {
    GENERATED_BODY()
public:
